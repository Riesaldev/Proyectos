      ...
      <div className="flex flex-col w-full h-2/3 gap-24 items-center">
        ...
        <div className="flex flex-col items-center w-full gap-6">
          ...
          <div className=" flex flex-col gap-2 w-3/4">
            <p className="text-neutral-400 text-xl ">We've emailed your ticket to <span className="text-orange-400 font-light ">{email}jonatan@email.com</span> and will send updates in the run up to the event.</p>
          </div>
        </div>
        {/* TicketPage Image */}
          ...
          <div className="relative w-full">
            ...
            <div className="absolute top-0 left-4 w-full h-full flex items-center justify-between gap-4 ">
              ...
              <div className="flex flex-col h-3/4 items-center justify-around ">
                ...
                <div className="flex flex-row w-full gap-2">
                  ...
                  <div className="flex flex-col items-start">
                    <h3 className="text-neutral-100 text-md font-light">{name}Jonatan Kristof</h3>
                    {/*GitHub username */}
                    <div className="flex flex-row items-center">{avatar}
                      ...
                      <p className="text-neutral-400 text-xs">{git}@jonatanKristof0101</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center rotate-90 ">
                ...
                <p className="text-neutral-500 text-3xl">{Ticketcode}#01609</p>
              </div>
            </div>
          </div>
