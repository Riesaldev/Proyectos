...
const TicketPage = () => {
  return (
    <div className="relative bg-[url(/assets/images/background-mobile.png)] bg-no-repeat bg-center brightness-120 bg-cover min-h-screen w-full flex flex-col items-center justify-start text-white z-0
      md:bg-[url(/assets/images/background-desktop.png)] md:bg-cover">
      <div className="h-full w-full flex flex-col bg-[url(/assets/images/pattern-lines.svg)] bg-no-repeat bg-[length:270%] items-center md:bg-[length:100%]">
