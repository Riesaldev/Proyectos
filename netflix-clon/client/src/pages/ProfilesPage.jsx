    ...
    return (
        <>
            ...
            <div className="h-screen w-screen">
                ...
                <FormLayout >
                    <div className=" h-1/2 w-auto mt-16 items-center mx-auto rounded-lg flex flex-col">
                        ...
                        <Button
                            variant="secondary"
                            className="w-1/2 mx-auto my-6 shadow-red-500 bg-gray-600 text-white text-lg font-medium tracking-wider hover:bg-gray-600 hover:text-gray-900 cursor-pointer"
                            onClick={() => {
