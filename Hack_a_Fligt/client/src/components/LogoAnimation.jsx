...
const LogoAnimation = () => {
    ...
    return (
        <section className='logo-animation-section relative flex flex-col items-center justify-center bg-dark-blue h-screen'>
            <h2
                id='first-h2'
                className='relative bottom-8 z-10 text-5xl font-semibold text-white mb-4'
            ></h2>
            ...
            <h2
                id='second-h2'
                className='relative top-8 z-10 text-5xl font-semibold text-white mb-4'
            ></h2>
        </section>
    );
};
