export const portfolioScrollContents = [
  {
    title: "El Lago de La Dama",
    content: "<p>Varios dias de busqueda en el plano onírico han llevado al Mago y su asistente a encontrar un lago de aguas cristalinas, rodeado de montañas y donde la Dama del Lago les espera.</p>" +
      "<p>El aire está impregnado de magia y misterio, y el sonido del agua fluyendo crea una melodía hipnótica y la Dama del Lago aparece ante ellos, sonriendo. Su presencia irradia calma y poder y esta conformada por la misma esencia del lago.</p>" +
      "<p>Con un gesto suave, la Dama del Lago les invita a acercarse, y el Mago siente que ha llegado el momento de revelar su propósito: encontrar la Espada del Destino. La Dama del Lago asiente, comprendiendo la importancia de su misión y les revela la <strong>ubicación de la espada</strong>.Son las Hadas, en su plano, quienes protegen y guardan La Espada del Destino.Estan cada vez más cerca.</p>"
  },
  {
    title: "Portfolio",
