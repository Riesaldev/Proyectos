    ...
    useEffect(() => {        let scene, camera, renderer, fogMaterial, animationId;
                    ...
                    void main() {
                        ...
                        for(int i = 0; i < 20; i++) {
                            ...
                            if(age < 4.0 && age > 0.01) {
                                ...
                                // Distorsión direccional como el movimiento de un palo
                        ...
                        float mouseInfluence = exp(-dist * 10.0); // Reducido de 15.0 a 10.0 para mayor área
                        ...
                        float clearing = totalEffect * 1.5; // Intensidad del clearing
        ...
        <div 
            ...
            style={{
                ...
                height: '100%',
                zIndex: 10,
                pointerEvents: 'none' // CRÍTICO: Permite que los clicks pasen a través
            }}
        />
    );
}
