      ...
      <div className="flex justify-center space-x-6">
        {socialLinks.map((link) => (
          <a
            ...
            className="flex items-center justify-center w-12 h-12 bg-amber-100 hover:bg-amber-200 text-amber-800 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
            aria-label={`${t('contact.social.visitProfile')} ${link.name}`}
          >
            {link.icon}
          </a>
        ))}
